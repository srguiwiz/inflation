...
const cacheName = "inflation-ch-annual";
...
self.addEventListener("install", (installEvent) => {
  async function createAndFillCache() {
    ...
    await cache.addAll([
      ...
      "./manifest.json",
      "./inflation-ch.svg",
      "./inflation-ch-48x48.png",
      "./inflation-ch-72x72.png",
      "./inflation-ch-96x96.png",
      "./inflation-ch-128x128.png",
      "./inflation-ch-256x256.png",
      "./inflation-ch-512x512.png",
    ]);
  }
