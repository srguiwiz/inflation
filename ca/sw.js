...
const cacheName = "inflation-ca-annual";
...
self.addEventListener("install", (installEvent) => {
  async function createAndFillCache() {
    ...
    await cache.addAll([
      ...
      "./manifest.json",
      "./inflation-ca.svg",
      "./inflation-ca-48x48.png",
      "./inflation-ca-72x72.png",
      "./inflation-ca-96x96.png",
      "./inflation-ca-128x128.png",
      "./inflation-ca-256x256.png",
      "./inflation-ca-512x512.png",
    ]);
  }
